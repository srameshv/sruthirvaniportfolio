export default function ProfessionalPage() {
  return (
    <div>
      <h1 className="text-xl font-medium text-neutral-900 leading-relaxed mb-8">
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-medium text-neutral-900">Project Alpha</h3>
          ...
          <div>
            <h3 className="font-medium text-neutral-900">Project Beta</h3>
            <p className="text-neutral-700 mt-1 leading-relaxed">
          ...
          <div>
            <h3 className="font-medium text-neutral-900">Project Gamma</h3>
            <p className="text-neutral-700 mt-1 leading-relaxed">
