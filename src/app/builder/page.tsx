export default function BuilderPage() {
  return (
    <div>
      <h1 className="text-xl font-medium text-gray-900 mb-10">What I'm Building</h1>
      ...
      <section className="mb-14">
        ...
        <div className="border-l border-gray-200 pl-5">
          <p className="text-gray-600 leading-relaxed mb-3">
            Right now I'm deep in <span className="text-gray-900">AI-assisted developer tools</span> — exploring
        ...
        <div className="space-y-8">
          <div>
            <div className="flex items-baseline justify-between gap-4">
              <h3 className="font-medium text-gray-900">Local-first sync engine</h3>
              <span className="text-xs text-gray-400">prototyping</span>
            </div>
          ...
          <div>
            <div className="flex items-baseline justify-between gap-4">
              <h3 className="font-medium text-gray-900">CLI for personal knowledge management</h3>
          ...
          <div>
            <div className="flex items-baseline justify-between gap-4">
              <h3 className="font-medium text-gray-900">WebGPU graphics experiments</h3>
